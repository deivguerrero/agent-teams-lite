...
name: sdd-commit
description: >
  Generate CHANGELOG.md entry and create conventional commit with Engram sync.
  Trigger: When the orchestrator launches you to commit a completed change.
license: MIT
metadata:
...
Spec: sdd/implement-rate-limiting/
...
Spec: sdd/refactor-auth-response/
Tasks: 8/8 completed
